...
namespace MQ2DotNetCore.MQ2Api
{
	...
	public class MQ2Tlo
	{
		...
		public MQ2Tlo(MQ2TypeFactory typeFactory)
		{
		...
		{
			private readonly MQ2Tlo _tlo;
			private readonly string _name;

			internal IndexedTLO(MQ2Tlo tlo, string name)
			{
				_tlo = tlo;
				_name = name;
			}
		...
		{
			internal IndexedTLO(MQ2Tlo tlo, string name) : base(tlo, name)
			{
			}
		}
