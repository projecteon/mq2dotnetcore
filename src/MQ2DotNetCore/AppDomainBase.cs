...
//            var symbolPath = Path.Combine(folderPath, new AssemblyName(args.Name).Name + ".pdb");
//            var symbolData = File.ReadAllBytes(symbolPath);

//            return File.Exists(assemblyPath) ? Assembly.Load(assemblyData,symbolData) : null;
//        }
